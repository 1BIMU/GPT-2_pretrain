#!/bin/bash
#===============================================================================
# GPT-2 训练脚本 - 无 Dropout (0.0)
#
# 功能：
# 1. 检查数据集是否存在
# 2. 训练不带 Dropout=0.0 的 GPT-2
# 3. 支持多卡 DDP 训练
# 4. 支持断点续训: bash train_without_dropout.sh --resume
#===============================================================================
...
echo ""
echo "╔══════════════════════════════════════════════════════════════════╗"
echo "║          GPT-2 Training WITHOUT Dropout (0.0)                    ║"
echo "╚══════════════════════════════════════════════════════════════════╝"
echo ""
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
log_info "Step 2: Training model WITHOUT Dropout (${DROPOUT})..."
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"

OUTPUT_DIR="${OUTPUT_BASE}/gpt2-dropout-${DROPOUT}"

if [ -d "${OUTPUT_DIR}/final" ] || ls -d "${OUTPUT_DIR}"/checkpoint-* &>/dev/null; then
